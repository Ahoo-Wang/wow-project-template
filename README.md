...
| [client](./client)                              | **客户端库**，基于 API 层生成的 TypeScript 客户端库，提供类型安全的 API 调用接口，方便前端或其他服务与后端交互。                                                                 |
...
- 将模板压缩包放到 IDEA 项目模板目录下
    - 模板压缩包: https://gitee.com/AhooWang/wow-project-template/releases/download/v6.2.0/wow-project-template.zip
